...
<div class="bg-slate-200 flex h-screen">
  <aside class="fixed z-50 md:relative">
    ...
    <nav aria-label="Sidebar Navigation" class="peer-checked:w-64 left-0 z-10 flex h-screen w-0 flex-col overflow-hidden bg-teal-200 text-white transition-all md:h-screen md:w-64 lg:w-72">
      <div class="bg-slate-800 mt-5 py-4 pl-10 md:mt-10">
        <span class="">
          <span class="mr-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 align-bottom text-2xl font-bold">Vetms</span>
          <span class="text-xl">&nbsp;&nbsp;&nbsp;Logo</span>
        </span>
      </div>
      <ul class="mt-8 space-y-3 md:mt-20">
        <li class="relative">
          <button class=" font-semibold focus:bg-teal-500 hover:bg-teal-500 flex w-full space-x-2 rounded-md px-10 py-4 text-stone-950 focus:outline-none">
            <span
              ><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="my-6 mt-auto ml-10 flex cursor-pointer">
        ...
        <div class="ml-3">
          <p class="font-medium text-stone-950">Diana Reeves</p>
          <p class="text-sm text-stone-950">Kyiv, Ukraine</p>
        </div>
      </div>
    </nav>
  </aside>
